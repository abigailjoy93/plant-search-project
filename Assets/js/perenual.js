...
var APIKey = "sk-H7Cr64bf0fc04c4ee1664"; // Bill's API Key
...
function getSpecies_Test() {
  fetch(
    "https://perenual.com/api/species-list?key=sk-H7Cr64bf0fc04c4ee1664&page=2", // *** No `assignment =` on this line
    {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  return fetch(`${url}&page=${page}`) // Append the page number to the base URL
    ...
    .then((newResponse) => {
      if (page === 1) {
        ...
        thead.append(
          `<tr><th>Id</th><th>Common Name</th><th>Scientific Name</th><th>Cycle</th></tr>`
        );
        tbody.append(
          `<tr><td id="id"></td><td id="common_name"></td><td id="scientific_name"></td></tr><td id="cycle"></td>`
        );
